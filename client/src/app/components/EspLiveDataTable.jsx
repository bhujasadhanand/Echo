...
function statusFromFill(fillLevel) {
  ...
  if (fillLevel <= 30)
    return { label: "Empty", className: "bg-green-100 text-green-800" };
  if (fillLevel <= 80)
    return { label: "Half Filled", className: "bg-yellow-100 text-yellow-800" };
  return { label: "Full", className: "bg-red-100 text-red-800" };
}

const isHighPriority = (fillLevel) =>
...
export function EspLiveDataTable({ data }) {
  return (
    <Card>
      <CardHeader>
