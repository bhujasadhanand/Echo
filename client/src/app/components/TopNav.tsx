...
const cities = ['New York City', 'Los Angeles', 'Chicago', 'Houston', 'Phoenix', 'San Francisco'];
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <Popover open={isSettingsOpen} onOpenChange={setIsSettingsOpen}>
            <PopoverTrigger asChild>
              <button className="p-2 hover:bg-gray-100 rounded-lg transition-colors" type="button" title="Settings">
            ...
            <PopoverContent align="end" sideOffset={12} className="w-80 p-4 bg-white border border-gray-200 shadow-lg">
              <div className="space-y-4">
                ...
                {[
                  { id: 'top-notifications', label: 'Enable Notifications', value: notificationsEnabled, onChange: setNotificationsEnabled },
                  { id: 'top-auto-refresh',  label: 'Auto-refresh Data',    value: autoRefreshEnabled,   onChange: setAutoRefreshEnabled },
                  { id: 'top-compact-view',  label: 'Compact View',         value: compactViewEnabled,   onChange: setCompactViewEnabled },
